...
*\# Objective Function: 50x\_1 \+ 80x\_2*

*\# Constraint 1: 5x\_1 \+ 2x\_2 <= 20*

*\# Constraint 2: \-10x\_1 \+ \-12x\_2 <= \-90*

result = scipy\.optimize\.linprog\(

    \[50, 80\],  *\# Cost function: 50x\_1 \+ 80x\_2*

    A\_ub=\[\[5, 2\], \[\-10, \-12\]\],  *\# Coefficients for inequalities*

    b\_ub=\[20, \-90\],  *\# Constraints for inequalities: 20 and \-90*

\)

__if__ result\.success:

    print\(f"X1: __\{__round\(result\.x\[0\], 2\)__\}__ hours"\)

    print\(f"X2: __\{__round\(result\.x\[1\], 2\)__\}__ hours"\)
