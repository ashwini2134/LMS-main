...
Consider a standard 52-card deck of cards with 13 card values (Ace, King, Queen, Jack, and 2–10) in each of the four suits (clubs, diamonds, hearts, spades).
...
Imagine flipping two fair coins, where each coin has a Heads side and a Tails side, with Heads coming up 50% of the time and Tails coming up 50% of the time.

What is the probability that after flipping those two coins, one of them lands heads and the other lands tails?
...
![Quiz 2, Question 3](https://cs50.harvard.edu/ai/quizzes/images/q2q3.png)
...
- Factory B produces the other 40%.
