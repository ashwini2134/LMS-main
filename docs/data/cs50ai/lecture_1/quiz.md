...
There are other logical connectives that exist, other than the ones discussed in lecture. One of the most common is “Exclusive Or” (represented using the symbol ⊕).
...
Which of the following is a propositional logic representation of the sentence:
...
Consider, in first-order logic, the following predicate symbols:

- `Student(x)` represents the predicate that “x is a student.”
- `Course(x)` represents the predicate that “x is a course.”
