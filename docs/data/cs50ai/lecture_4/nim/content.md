...
## [**When to Do It**](https://cs50.harvard.edu/ai/projects/4/nim/#when-to-do-it)

By [Friday, January 1, 2027 at 5:29 AM GMT+5:30](https://time.cs50.io/20261231T235900Z)

## [**How to Get Help**](https://cs50.harvard.edu/ai/projects/4/nim/#how-to-get-help)

1. Ask questions via [Ed](https://cs50.edx.org/ed)!
2. Ask questions via any of CS50’s [communities](https://cs50.harvard.edu/ai/communities/)!

## [**Background**](https://cs50.harvard.edu/ai/projects/4/nim/#background)
...
## [**Getting Started**](https://cs50.harvard.edu/ai/projects/4/nim/#getting-started)

- Download the distribution code from https://cdn.cs50.net/ai/2023/x/projects/4/nim.zip and unzip it.

## [**Understanding**](https://cs50.harvard.edu/ai/projects/4/nim/#understanding)
...
## [**Specification**](https://cs50.harvard.edu/ai/projects/4/nim/#specification)
...
## [**Hints**](https://cs50.harvard.edu/ai/projects/4/nim/#hints)

- If `lst` is a list, then `tuple(lst)` can be used to convert `lst` into a tuple.

## [**Testing**](https://cs50.harvard.edu/ai/projects/4/nim/#testing)
...
## [**How to Submit**](https://cs50.harvard.edu/ai/projects/4/nim/#how-to-submit)
